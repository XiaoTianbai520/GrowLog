...
with sync_playwright() as p:
    ...
    page.get_by_role('button', name='分栏', exact=True).click()
    ...
    (output / 'editor-safety-report.json').write_text(json.dumps({'sqliteWriteFailureRetainsDraft':'passed','navigationBlockedUntilRetry':'passed','sourceImageRemoval':'passed','threeEditorModes':'passed','collapsedNavigation':'passed','noteScaleViewports':'passed'},indent=2),encoding='utf-8')
